...
public class Cereal {
         ...
         * @param c The cereal to get the rating of
         * Example: 100% Bran | 70 cal | 4 protein | 1 fat | 130 sodium | 10 fiber | 5 carb | 6 sugar | 280 potassium | 25 vitamin
         * Rating = 
         */
        public double getNutritionRating(Cereal c) {
            
            double rating = (c.protein * 2 + c.fiber * 2 - c.fat * 0.5 - c.sugar * 1 * c.potassium/c.sodium + 0.1 * c.vitamins) * (c.protein + c.fiber)/c.calories;
            return rating;
        }
}